...
keyutils.add_key.argtypes = [ctypes.c_char_p, ctypes.c_char_p, ctypes.c_void_p, ctypes.c_size_t, ctypes.c_int32]
...
keyutils.request_key.argtypes = [ctypes.c_char_p, ctypes.c_char_p, ctypes.c_char_p, ctypes.c_int32]
    ...
    def get_refresh_token(self):
        ...
        for attempt in range(3):
            ...
            if bytes_read > required_len:
                ...
                logger.debug(f"Key size changed during read (Attempt {attempt+1}/3). Retrying...")
                continue 
